...
(function() {
  var addCommitLog, dryRun, fs, getCommonHostGroup, getDepVers, getPackageJsonCommits, git, logCommit, logVerbose, main, mostCommon, path, readRepo, root, tagline, updatePackageJson,
