...
(function() {
  ...
  main = function() {
    var commitLogs, cutCommits, depIsIgnored, depVers, file, linkedPaths, mostCommonGroup, mostCommonHost, newestCommits, node_modules, numProjects, p1, p2, p3, packageJson, projectName2DepName, rawPackageJson, readProject, stats, _i, _len, _ref, _ref1, _ref2;
    ...
    newestCommits = {};
    depIsIgnored = {};
    readProject = function(fileNum) {
      var cutCommit, depName, isLast, projectName;
      ...
      return readRepo(commitLogs, newestCommits, cutCommit, projectName, file, function(commitLogs) {
    ...
    return readProject(0);
  };

  updatePackageJson = function(cutCommits, projectName2DepName, depIsIgnored, rawPackageJson, commitLogs, newestCommits) {
  ...
  readRepo = function(commitLogs, newestCommits, cutCommit, projectName, gitPath, callback) {
    var repo;
