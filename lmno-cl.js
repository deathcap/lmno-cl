...
(function() {
  var addCommitLog, dryRun, fs, getCommonHostGroup, getDepVers, getPackageJsonCommits, git, logCommit, logVerbose, main, mostCommon, path, readRepo, root, shellescape, tagline, updatePackageJson,
  ...
  main = function() {
    var commitLogs, cutCommit, cutCommits, depVers, file, fileNum, isLast, linkedPaths, mostCommonGroup, mostCommonHost, newestCommits, node_modules, numProjects, p1, p2, p3, packageJson, projectName, rawPackageJson, stats, _i, _j, _len, _len1, _ref, _ref1, _results;
